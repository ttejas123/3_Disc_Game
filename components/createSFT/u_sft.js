...
function Upload({metaplex, setTab, setimgToSet}) {
    ...
    return (
        <div className={style.box}>
            ...
            <div className='w-full flex justify-center items-center'>
                <div className='w-[10%] flex items-center justify-center bg-blue-50 mt-5 px-3 py-2 rounded-lg cursor-pointer shadow-md text-center' onClick={uploadHit}>
                    <>
                        {uploading && (<>
